...
export default class Articles extends Component {
  ...
  getArticles = query => {
    ...
    let key = `&api-key=75c5e58591ca412fa9f37b442716e5cb`
            ...
            <Panel>
              ...
              <PanelBody>
                <Form style={{marginBottom: '30px'}}>
                  ...
                  <FormGroup >
                    <Label htmlFor="sYear">Enter a beginning date(optional):</Label>
                    <Input
                      onChange={this.handleInputChange}
                      type='date'
                      name='sYear'
                  ...
                  <FormGroup >
                    <Label htmlFor="eYear">Enter an end date(optional):</Label>
                    <Input
                      onChange={this.handleInputChange}
                      type='date'
                      name='eYear'
